console.log(`[ BOOT ] DforDog Riffy voice-handshake recovery v12 loaded | commit=${process.env.RENDER_GIT_COMMIT || process.env.GIT_COMMIT || 'unknown'}`);
...
require("./utils/riffyVoiceHandshakeRecovery.js");
